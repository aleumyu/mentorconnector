...
class RegisterForm extends Component {
  ...
  addUser(e) {
    ...
    if (
      ...
      !newUser.lastName ||
      !newUser.industry ||
      !newUser.industry === "select" ||
      !newUser.jobType ||
      !newUser.country ||
      newUser.country === "select" ||
      newUser.role === 0 ||
      newUser.meeting === 0 ||
      newUser.interestTag[0] === undefined
    ) {
      this.setState({
        alert: true
      });
    ...
    return (
      <div className="App">
        ...
        <p>
          ...
          women in technology. We achieve this by matching mentors and mentee
          based on their career path and objectives.
        </p>
        <p>
          Filling out our membership form will ensure we're able to best match
          mentors and mentees.
        </p>

        {this.state.alert ? <RegisterFormAlert /> : null}
          ...
          <fieldset>
            <ul>
              ...
              <li>
                ...
                <p>
                  Select the option that best describes your focus in
                  technology.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  How would you define your level of expertise in your career
                  path?
                </p>
              </li>
              ...
              <li>
                <label>
                  How would you like to meet with your mentor/mentee?
                </label>
                <select
                  name="meeting"
              ...
              <li>
                <label>
                  How do you hope to benefit from this mentorship program?
                </label>
              ...
              <li>
                <label>
                  Introduce yourself and what kind of match you are hoping to
                  find.
                </label>
                <textarea
                  name="intro"
